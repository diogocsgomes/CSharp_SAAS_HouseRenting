...
namespace Trabalho_Pratico_23_24.Controllers
{
    ...
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Descricao")] Categorias categorias)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Descricao")] Categorias categorias)
        {
            if (id != categorias.Id)
            {
                return NotFound();
